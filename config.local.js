...
export default {
    ...
    baseAppUrl: process.env.BASE_APP_URL, // use "https://yourdomain.com/path" where you have Iframely in your reverse proxy
    relativeStaticUrl: "/r",
    ...
    */
    CACHE_ENGINE: 'redis',
    CACHE_TTL: 1000 * 60 * 5, // In seconds.
    ...
    */
    ...
    ADD_OEMBED_PARAMS: [{
        ...
        params: { // Custom query-string params object.
            ...
            access_token: process.env.FACEBOOK_ACCESS_TOKEN,   // The simplest way is
